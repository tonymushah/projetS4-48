...
<body>
  ...
  <section class="section contact">
    <div class="row gy-4">
        <div class="col-xl-6">
            <div class="card p-4">
            <form action="<?php echo site_url('index.php/Programme/Modif_detail');?>" method="post">
                <h1 style="text-align:center">Modifier details programme</h1>
                <div class="row gy-4">
                    <input type="hidden" name="iddetail" value="<?php echo isset($details) ? $details['iddetails'] : ''; ?>">
                <div class="col-md-6 ">
                    <input type="text" class="form-control" name="nom" value="<?php echo isset($details) ? $details['nom'] : ''; ?>" placeholder="Nom" required>
                </div>
                
                <div class="col-md-6">
                    <input type="number" name="duree" class="form-control" value="<?php echo isset($details) ? $details['duree_jour'] : ''; ?>" placeholder="Durée" required>
                </div>

                <div class="col-md-12">
                    <select class="form-control" value="<?php echo isset($details) ? $details['type_'] : ''; ?>" name="type" id="type">
                ...
                <div class="col-md-12">
                    <input type="number" name="prix" class="form-control" value="<?php echo isset($details) ? $details['prix'] : ''; ?>" placeholder="Prix" required>
                </div>
