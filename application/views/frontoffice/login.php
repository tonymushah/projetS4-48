...
<head>
  ...
  <title>Pages / Login - NiceUser Bootstrap Template</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="<?php echo site_url('index.php/Auth/process_login');?>" method="post" class="row g-3 needs-validation" novalidate>
                    <?php if(isset($errorl)) { ?>
                        <div class="col-12">
